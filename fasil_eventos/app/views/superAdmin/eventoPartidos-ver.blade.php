                ...
                <div class="row">
                  ...
                  <div class="row submit-ver">
                      <div class="col m12">
                          <div class="row">
                            <div class="col s4">
                            <a class="btn btn-large  blue darken-3" href="{{route('vEditarEventoPartido',[$evento->slug, $evento->id])}}" name="action">Editar Partido<i class="material-icons right">business</i>
                            </a>
                          </div>
                          <div class="col s4">
                            <a class="btn btn-large blue darken-3" href="{{route('vCrearHorarioPartido',[$evento->slug, $evento->id])}}" name="action">Agregar Sectores<i class="material-icons right">note_add</i>
                            </a>
                          </div>
                          <div class="col s4">
                            <a class="btn btn-large red darken-3" href="{{route('vEliminarEventoPartido',[$evento->slug, $evento->id])}}" name="action">Eliminar Evento<i class="material-icons right">delete</i>
                            </a>
                          </div>  
                        </div>
                      </div>   
                    ...
                    <div class="col s12 m6">
                      ...
                      <span class="card-title black-text">Horario</span> <br>
                        <span class="black-text">
                          <strong>{{$queryPeliculaHorarioss->sector_nombre}}</strong>
                          {{$queryPeliculaHorarioss->sector_descripcion}} <br>
                          Precio: {{$queryPeliculaHorarioss->sector_precio}} Bs. <br>
                          Stock: {{$queryPeliculaHorarioss->sector_stock}}<br>
                          Limite Stock: {{$queryPeliculaHorarioss->sector_limiteStock}}<br>
                          @if($queryPeliculaHorarioss->sector_estado == 1)
                           Estado: Habilitado
                          @endif
                        </span>
                      </div>
