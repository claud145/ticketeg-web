                  ...
                  <div class="card white">
                    ...
                    <img src="{{asset('styles/img/logotipo1.png')}}" class="responsive-img">
                      <span class="card-title black-text">Registra tu cuenta</span>
                        <div class="row">
                            <h3>Confirma tu correo electronico para Completar el registro de tu cuenta</h3>
                            <a class="waves-effect waves-light btn"><i class="material-icons left">cloud</i>Volver a Ticketeg</a>
                        </div>
                    </div>  
                    </div>
                  </div>
